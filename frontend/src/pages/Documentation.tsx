      ...
      <div className="space-y-8">
        <section>
          ...
          <div className="bg-terminal-green/5 border border-terminal-green/30 p-4 rounded mb-4">
            <p className="text-terminal-green/80 leading-relaxed mb-3">
              <strong>Krypt Terminal is 100% transparent and verifiable.</strong> Our AI agent uses proprietary AI 
              technology to develop actual blockchain code, with every step visible to users.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <ul className="text-terminal-green/70 text-sm space-y-1">
                  ...
                  <li>• Authentic development process</li>
            ...
            <div className="border border-terminal-green/30 p-4 rounded">
              ...
              <div className="text-terminal-green/70 space-y-2">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <span>Sends request to proprietary AI development engine</span>
                </div>
                <div className="flex items-start space-x-3">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-black/50 p-4 rounded border border-terminal-green/30">
              <h4 className="text-terminal-green font-semibold mb-3">Platform Verification</h4>
              <div className="text-terminal-green/70 text-sm">
                All development activity, user statistics, and progress data can be verified in real-time through the platform's transparent interface and development logs.
              </div>
            </div>
          </div>
        </section>
